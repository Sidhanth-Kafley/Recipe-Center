        ...
        print PHP_EOL . '<!-- SECTION 3c html Form -->' . PHP_EOL;
            ...
            <form action=''<?php print PHP_SELF; ?>'
                ...
                <fieldset>
                    ...
                    if (is_array($Materials)) {
                        foreach ($Materials as $material) {
                            print "\t" . '<label for="chk' . str_replace(" ", "", $material["pmkMaterials"]) . '"><input type="checkbox" ';

                            print ' id="chk' . str_replace(" ", "", $material["pmkMaterials"]) . '"';
                            print ' name="chkArrays[]" ';
                ...
                <fieldset class="buttons">
                    <legend></legend>
                    <input class="btn btn-lg btn-primary btn-block" id="btnSubmit" name="btnSubmit" tabindex="900" type="submit" value="Add Recipe">
